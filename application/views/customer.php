            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item active">Database customer, masukan semua customer ke dalam sini</li>
                            </ol>
                        </div>
                        <div class="col-6 mt-5 text-right" style="text-align: right;">
                            <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#modalCustomer"><i class="fa fa-plus"></i> Tambah Customer</button>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="table-customer" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Klien</th>
...
<script>
    ...
    $(function() {
        $("#table-customer").DataTable({
            ...
            'ajax': {
                'dataType': 'json',
                'url': '<?= base_url() ?>xyz/ajax_table_customer',
                'type': 'post',
            },
            'columns': [{
                "target": [<?= $target ?>],
